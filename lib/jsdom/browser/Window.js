...
const MimeTypeArray = require("../living/generated/MimeTypeArray");
const PluginArray = require("../living/generated/PluginArray");
...
function Window(options) {
  ...
  // Create the empty mime type array
  const mimeTypeArray = MimeTypeArray.create();

  // Create the plugins
  const pluginArray = PluginArray.create(options, mimeTypeArray);

  // now that we have the plugins, create the mime types
  mimeTypeArray.addMimeTypes(options, pluginArray);
